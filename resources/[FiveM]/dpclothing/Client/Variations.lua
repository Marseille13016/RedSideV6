...
Citizen.CreateThread(function()
	...
	AddNewVariation("Hair", "Female", 2, 19, true)
	AddNewVariation("Hair", "Female", 5, 11, true)
	AddNewVariation("Hair", "Female", 7, 19, true)
	AddNewVariation("Hair", "Female", 8, 11, true)
	AddNewVariation("Hair", "Female", 10, 11, true)
	AddNewVariation("Hair", "Female", 15, 49, true)
	AddNewVariation("Hair", "Female", 21, 17, true)
	AddNewVariation("Hair", "Female", 26, 49, true)
	AddNewVariation("Hair", "Female", 53, 49, true)
	AddNewVariation("Hair", "Female", 27, 52, true)
	AddNewVariation("Hair", "Female", 30, 28, true)
	AddNewVariation("Hair", "Female", 28, 30, true)
	AddNewVariation("Hair", "Female", 29, 30, true)
	AddNewVariation("Hair", "Female", 31, 60, true)
	AddNewVariation("Hair", "Female", 42, 45, true)
	AddNewVariation("Hair", "Female", 48, 49, true)
	AddNewVariation("Hair", "Female", 59, 54, true)
