...
RegisterNetEvent("emote:StopEmote")
AddEventHandler("emote:StopEmote", function()
...
function DestroyAllProps()
  for k,v in pairs(PlayerProps) do
    DeleteEntity(v)
    TriggerServerEvent("DeleteEntity", token, ObjToNet(v))
    table.remove(PlayerProps, k)
  end
  PlayerHasProp = false
...
function AddPropToPlayer(prop1, bone, off1, off2, off3, rot1, rot2, rot3)
  ...
  prop = CreateObject_(GetHashKey(prop1), x, y, z+0.2,  true,  true, true)
